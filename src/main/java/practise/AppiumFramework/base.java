...
public class base {
	...
	public static AndroidDriver<AndroidElement> capabilities(String appName) throws IOException, InterruptedException {
		...
		if (runMode.contains("mvn_command")) {
			String device_mvn_mode = System.getProperty("deviceName");
			device=device_mvn_mode;
		}
		else
		{
			String device_default_mode = (String) prop.get("device");
			device=device_default_mode;
		}
